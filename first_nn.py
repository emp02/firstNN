...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        #self.batchNormalization54 = nn.BatchNorm2d(54)
        #self.batchNormalization486 = nn.BatchNorm2d(486)
        #self.batchNormalization972 = nn.BatchNorm1d(972)
        #self.batchNormalization324 = nn.BatchNorm1d(324)
        #self.batchNormalization81 = nn.BatchNorm1d(81)
    ...
    def forward(self, x):
        ...
        #x = self.batchNormalization54(x)
        x = self.pool1(x)
        #x = self.dropout15(x)
        x = self.activation(self.conv3(x))
        #x = self.batchNormalization486(x)
        x = self.pool1(x)
        #x = self.dropout20(x)
        x = x.view(-1, 1944)
